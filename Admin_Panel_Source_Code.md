# Admin Panel Source Code for New Project

আপনি গুগল এআই স্টুডিওতে নতুন প্রজেক্ট তৈরি করে এই কোডগুলো দিয়ে অ্যাডমিন প্যানেল তৈরি করতে পারবেন। এটি ১০০% রিয়েল-টাইম কাজ করবে। নিচে ফ্রন্টএন্ড এবং ব্যাকএন্ডের কোড দেওয়া হলো:

## 1. Frontend (src/components/AdminPage.tsx)
এই কোডটি নতুন প্রজেক্টের `src/components/AdminPage.tsx` ফাইলে পেস্ট করবেন:
...
## 2. Backend API Routes (server.ts এ যুক্ত করতে হবে)
নতুন প্রজেক্টের `server.ts` ফাইলে এই রাউটগুলো অ্যাড করবেন:
